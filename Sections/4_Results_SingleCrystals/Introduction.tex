...
% In-plane measurements were perfomed by rotating the in-plane sample angle $\omega$ together with the in-plane detector angle $\gamma$.
% Out-of-plane measurements were performed by rotating the in-plane sample angle $\omega$ together with the in-plane and out-of-plane detector angles respectively $\gamma$ and $\delta$, the incoming angle $\beta$ must stay at a low value to keep the grazing incidence of the beam as detailed in sec. \ref{sec:DataCollectionSXRD}.

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.33\textwidth]{/home/david/Documents/PhD/Figures/sample/sxrd_sample.png}
