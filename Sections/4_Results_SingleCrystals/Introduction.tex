...
The existence of a rhodium surface oxide during reacting conditions favouring \ce{NO} is revealed.
...
Lastly, the sample surface was exposed to a reduced pressure of oxygen, to make certain that the phenomena observed when lowering the \ce{O_2}/\ce{NH_3} ratio by reducing the oxygen pressure are effectively due to the combined presence of the reactants.
...
\caption{
    ...
    The duration of each condition was at least \qty{8}{\hour}.
    }
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/Figures/Sample/SampleAndSetups.pdf}
    \caption{
...
%, \textit{i.e.} close to the magic angle with respect to the polarisation vector.
