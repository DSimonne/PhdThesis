...
For Pt(111), a Pt(111)-p(8x8)-R\ang{0} commensurate superstructure was measured (fig. \ref{fig:MapsPt111A} - d), preceded by two Pt(111)-p(6x6)-R\ang{\pm 8.8} commensurate superstructures (no visible second order peak, fig. \ref{fig:MapsPt111A} - c).
Some of the peaks belonging to the rotated structures can also be described with the following matrix notation: Pt(111)-p$\begin{pmatrix} 1.08 & -0.21 \\ -0.21 & 1.08 \end{pmatrix}$-R\ang{0}, effectively describing a unit cell with a second order peak (fig. \ref{fig:MapsPt111A} - c).
Out-of-plane measurements have revealed a bi- or tri-layer structure (fig. \ref{fig:LScans80}), possibly corresponding to a $\alpha$-\ce{PtO_2} surface oxide.
...
\ce{Pt_3O_4} follows a Pt(100)-p(2x2)-R\ang{0} epitaxial relationship with the Pt(100) surface (fig. \ref{fig:Pt3O4onPt100}).
...
Some periodicity can be observed in the related out-of-plane signals at [H, K] = [0, -1.2] and [H, K] = [0.5, -1], high intensity peaks are observed at $L=1$ and $L=2$ for the measurement at [H, K] = [1.9, 0] (fig. \ref{fig:MapsAndLScansPt100HighOxAmmonia} - b), which can link the Pt(100)-p(10x10)-R\ang{0} surface reconstructions with the presence of 3D structures.
...
Lowering the \ce{O_2}/\ce{NH_3} ratio to \num{0.5} has removed the Pt(100)-p(10x10)-R\ang{0} surface reconstructions, and induced the appearance of a hexagonal Pt(100)-p(33x25)-R\ang{0} commensurate superstructure, with an out-of-plane signal consistent with that of monolayers (fig. \ref{fig:MapsAndLScansPt100LowOxAmmonia}).
...
Therefore, the Pt(100)-p(10x10)-R\ang{0} surface reconstruction can be linked to the presence of ordered oxygen species on the Pt(100) surface, which is only permitted by the simultaneous presence of ammonia, \textit{i.e.} linked to the reaction mechanism.
...
% roughness
The persisting presence of oxygen on the Pt(100) surface can also be linked to different evolutions of the catalysts surface roughness.
...
The  Pt(100)-p(10x10)-R\ang{0} surface reconstructions and Pt(100)-p(33x25)-R\ang{0} hexagonal structures present on the Pt(100) surface during reacting conditions (fig. \ref{fig:MapsAndLScansPt100HighOxAmmonia} - a, \ref{fig:MapsAndLScansPt100LowOxAmmonia} - a), can be linked to the remaining high roughness, whereas Pt(111) exhibits a bulk terminated surface (fig. \ref{fig:MapsPt111B} - a \& b).
...
If the oxygen pressure is seen to decrease directly after the change of condition in the RGA signal (fig. \ref{fig:RGA450Pt100Cycle}), the hexagonal structures are still measured in the first half of the in-plane reciprocal space map, \textit{i.e.} during the first hours of measurement.
...
Pt(111)-p(8x8)-R\ang{0} and Pt(111)-p(6x6)-R\ang{\pm 8.8} cannot be linked to an increase of decrease of the catalytic activity, and thus do not seem to take part in the reaction mechanism.
...
\begin{tabular}{@{}llll@{}}
    \toprule
    O2 & NH3 & Pt(111) & Pt(100) \\
    \midrule
    80 & 0  & Two hexagonal rotated Pt(111)-p(6x6)-R\ang{8.8} & Epitaxial Pt(100)-p(2x2)-R\ang{0} \\
       &    & commensurate superstructures (monolayer)        & structure (bulk \ce{Pt3O4}),      \\
       &    & After \qty{9}{\hour}\qty{30}{\minute}: Pt(111)-p(8x8)-R\ang{0}          & and signals shifted in H or K     \\
       &    & commensurate superstructure (multilayer)        & (monolayer)                       \\
    \midrule
    80 & 10 & No oxide layer / no reconstruction              & Pt(100)-p(10x10)-R\ang{0} reconstruction\\
       &    &                                                 & and signals shifted in H or K     \\
       &    &                                                 & (without out-of-plane structure)  \\
       &    &                                                 & Higher \ce{NO} selectivity, and   \\
       &    &                                                 & higher \ce{O_a} signal in O 1s in \\
       &    &                                                 & comparison with Pt(111)           \\
    10 & 10 & No oxide layer / no reconstruction              & Pt(100)-p(33x25)-R0°structure (monolayer) \\
       &    & \ce{N_a} and \ce{NH_{x,a}} in N 1s              & No more signal in O 1s level      \\
       &    &                                                 & Only \ce{N_a} in N 1s             \\
    5  & 10 & No oxide layer / no reconstruction              & Progressive removal of Pt(001)-p(33x25)-R0°structure \\
    0  & 10 & No oxide layer / no reconstruction              & No oxide layer / no reconstruction\\
    \midrule
    5  &  0 & Back to the same structures as at \qty{80}{\milli\bar} of \ce{O2}, & Transient structures, \\
       &    & but with decreased kinetics                     & different from the one at \qty{80}{\milli\bar} of \ce{O2} \\
    \bottomrule
\end{tabular}%
}
