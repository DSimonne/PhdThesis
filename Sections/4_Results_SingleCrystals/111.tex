...
The presence of $\alpha$-PtO$_2$ on Pt (111) has been shown to not hinder the oxidation of \ce{CO} by Ackermann et al. \parencite*{Ackermann2007}, that would then occur \textit{via} a Mars-Van Krevelen mechanism \parencite{Mars1954}, inducing a progressive roughnening of the platinum surface.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[trim=0 0 0 10cm, clip, width=\textwidth]{/home/david/Documents/PhDScripts/B07_2022_04_XPS/Figures/product_partial_pressure_comparison_vs_time.pdf}
    \caption{
...
A high \ce{O_2}/\ce{NH_3} ratio (8) favours the production of \ce{NO} as expected, accompanied by a high amount of water, small amounts of \ce{N_2} and \ce{N_2O} can also be detected.
Ammonia is still detected, which means that the oxygen is not yet in excess to allow the consumption of all the \ce{NH_3} present in the cell.
Lowering the amount of oxygen by reducing the \ce{O_2}/\ce{NH_3} ratio to 0.5 has the effect of removing entirely the presence of \ce{NO}, only \ce{N_2} can still be detected.
...
Derry et al. \parencite*{Derry1984} report a peak at \qty{530.8}{\eV} for O$_a$ on Pt (111) during its exposition to oxygen, while Zhu et al. \parencite{Zhu2003} also report O$_a$  at \qty{529.9}{\eV} when probing the dissociation of \ce{NO} on the Pt(111) surface.
...
During a recent study of the oxidation of ammonia at different pressures and \ce{O_2}/\ce{NH_3} ratio on Pt(111) has reported (2x2) chemisorbed oxygen and OH at respectively \qty{529.7}{\eV} and \qty{531.4}{\eV} in \qty{1}{\milli\bar} of oxygen at \qty{325}{\degreeCelsius}.
...
% ratio 8
No nitrogen species can be detected in the N1s spectra when introducing \qty{1.1}{\milli\bar} of ammonia in the reactor while keeping the pressure of oxygen equal to \qty{8.8}{\milli\bar}.
...
The presence of gas phase \ce{NO}, and ammonia was expected from the mass spectrometer data but could not be detected.
...
The presence of \ce{NO}


% ratio 05
The doublet is absent when the \ce{O_2}/\ce{NH_3} ratio is equal to 0.5 confirming the mass spectrometer data and thus the complete use of the oxygen in the reactor at that condition.
...
\resizebox{\textwidth}{!}{%
    ...
    \midrule
    Gas presence & & Ar & \ce{O_2} & \ce{O_2}, \ce{H_2O}, \ce{NO}   & \ce{H_2O}, \ce{NH_3} & \ce{NH_3} & \ce{O_2} & Ar \\
     & &    &          & \ce{NH_3}, \ce{N_2}, \ce{N_2O} & \ce{N_2}             &           &          &    \\
    \midrule
    ...
    \multicolumn{2}{l|}{Corresponding surface moieties} &  &  &  & N2(g), NH$_{x}$, N$_{ad}$ & N2(g), NHx, N$_{ad}$ & N, NH, NH2 ? &  \\
    \midrule
