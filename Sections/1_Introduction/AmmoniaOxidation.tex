...
The story of ammonia begins in the early $20^{th}$ century with the discovery in 1902 of the Ostwald process that permitted the synthesis of fertilisers from the oxidation of ammonia.
...
Today, about \qty{50}{\percent} of the worlds population relies on nitrogen-based fertiliser to produce the food necessary to their alimentation (fig. \ref{fig:FertilizerWID}).
...
\ce{N_2O} may also react with ammonia to produce nitrogen and water.
It is also possible to observe the dissociation of ammonia resulting in the production of \ce{N_2} and \ce{H_2} (eq. \ref{eq:SideReactions5}) when in the absence of catalysts or outside industrial reacting conditions.
...
Nitrogen dioxide (\nitrogendioxide) is produced from \ce{NO} which then reacts with water to form nitric acid, an important actor in multiple industrial process (tab. \ref{tab:NitrogenGases}), including fertilisers such as ammonium nitrate (eq. \ref{eq:AmmoniumNitrate}).
...
Moreover, ammonia can also be used for the reduction of nitrogen oxides (eq. \ref{eq:SideReactions1} - \ref{eq:SideReactions4}), aiming at the production of nitrogen.
...
When aiming at the production of nitric acid, important selectivity towards the production of \ce{NO} must be achieved during the ammonia oxidation (eq. \ref{eq:AmmoniaOxidationNitrousOxide}), \textit{i.e.} during the first stage of the Ostwald process.
However, at low temperature or low \ce{O_2}/\ce{NH_3} ratios, the production of \ce{N_2} is favoured (eq. \ref{eq:AmmoniaOxidationNitrogen}), which is at the origin of the selective, heterogeneous catalytic oxidation of ammonia towards the production of nitrogen oxide.
...
First studies performed at low pressure and different temperatures have supported a Langmuir-Hinshelwood mechanism \parencite{Nutt1969, Pignet1974, Ostermaier1974, Pignet1975, Gland1978a}.
...
The importance of adsorbed atomic oxygen (\ce{O_a}) and adsorbed hydroxyl groups (\ce{OH_a}) in the de-hydrogenation of ammonia on both Pt(111) \parencite{Mieher1995} and Pt(100) surface was put into evidence by e.g. molecular beam studies under various oxygen coverages \parencite{Bradley1995, Bradley1997, vandenBroek1999, Kim2000}.
...
At UHV, the rotated hexagonal reconstruction of clean Pt(100) was found to impinge \ce{NH_3} de-hydrogenation at low temperature (\qty{-123}{\degreeCelsius}) \parencite{Bradley1997}.
...
Moreover, it was shown that the adsorbed \ce{NH_3} hopping rate is close to its desorption rate on Pt(111) terrace sites, making it unlikely to reach the steps where it may react rather than desorb from the catalyst surface \parencite{Borodin2021}.
...
The heterogeneous catalysis reaction mechanism was found to be similar on both sample, a pre-exposition of the catalysts to oxygen facilitated the de-hydrogenation of \ce{NH_3}, without which the decomposition towards \ce{N_2} was not detected.
...
In a second study, increasing the \ce{O_2}/\ce{NH_3} ratio to 10 pushed \ce{NO} selectivity to almost \qty{100}{\percent}, \ce{N_2} and \ce{N2_O} production being both suppressed by favouring \ce{NO} desorption \parencite{PerezRamirez2009}.

The advent of dynamical field theory (DFT) brought forward theoretical explanations of the reaction mechanism for the first time.
...
(i), the production of \ce{N_2O} was rarely discussed because undetected, van den Broek et al. \parencite*{vandenBroek1999} first hypothesised that \ce{NO} was a precursor in the production of nitrous oxide, produced \textit{via} an additional reaction with adsorbed oxygen.
...
\ce{N_2} was hypothetised to be produced from the association of two adsorbed nitrogen atoms, after the de-hydrogenation process.
Previous works mentionning oxidation of adsorbed ammonia by gas phase atoms was contradicted.
...
A comparative study between the Pt(100), Pt(111) and Pt(211) (\textit{i.e.} stepped) surfaces did not reveal a strong structure sensitivity of the \ce{NH_3} stripping process \parencite{Offermans2007}.
...
Such reactors are closed environment penetrable by x-rays, and accommodating a wide range of temperature, total pressure and gas compositions \parencite{VanRijn2010}.

% single crystals
The samples often used during SXRD and XPS experiments are single crystals, much larger than industrial samples.
For example, the industrial gauzes used during the oxidation of ammonia have a diameter of about \qty{70}{\um}, whereas single crystals are typically \unit{\cm} large (fig. \ref{fig:Samples}).
...
Nevertheless, they can show some limitations, for example large Pt(111) single-crystals also exhibit a significant amount of steps on their surface also contributing to the catalytic activity \parencite{CalleVallejo2017}.
...
Nanoparticles allow to better understand heterogeneous catalysis since they exhibit a various amount of active sites such as different facets (e.g. (111), (110), (100), ...), edges, corners and defects (fig. \ref{fig:Samples}).
...
This limitation also exists in BCDI, despite the highly focused beam, which draws a limit between experimental samples (so far, the smallest imaged nanoparticle is \qty{60}{\nm} large - \cite{Bjorling2019, Carnis2021}) and the few \unit{\nm} large nanoparticles used in dynamical field theory (DFT) or molecular dynamics (MD).
...
Obtaining a comprehensive understanding of these mechanisms is essential for controlling reaction selectivity, thereby mitigating pollution arising from \ce{NH_3} and \ce{NO_x} as well as reducing the specific greenhouse effect induced by \ce{NO_2}.
...
X-ray photoelectron spectroscopy will be carried out at the B07 beamline (Diamond), also compatible with high pressures \parencite{Held2020}.
...
The study of the reaction will be performed \textit{operando}, by exploring the large parameter space defined by the operating temperature, total pressure, and \ce{O_2}/\ce{NH_3} ratio.
The utilization of diverse samples will contribute to a comprehensive understanding of the underlying structural dynamics.
...
The first chapter of the thesis has delved into the history of the subject and its societal impacts, setting the stage os this thesis.
...
This section emphasizes the origins, advantages, and constraints of each technique used in the study, highlighting how x-rays can indirectly observe catalytic reactions by detecting unique markers left on the materials.
The SixS beamline at synchrotron SOLEIL, the primary tool for most experiments, will be introduced, emphasizing the latest advancements in experimental techniques and beamline-specific hardware.
...
The new software's aim to facilitate the reduction and analysis of data in \textit{Python}, while encouraging broader adoption of the technique through a user-friendly graphical interface, will be described.
...
Pt nanoparticles and single crystals are employed to explore the structure-selectivity relationship at ambient pressure and high temperature by the means of a vast array of \ce{O_2}/\ce{NH_3} ratios, favouring either the production of \ce{N_2} or \ce{NO}.
...
Thus, the difference in activity between different crystalline facets will be studied with different samples that, together, offer a good compromise between industrial catalysts and compatibility with the experimental setup of synchrotron beamlines.
...
The last chapter critically analyzes the correlation between the results obtained from each technique, comparing them to existing literature findings.
The chapter assesses their reliability, representativeness, and validity, offering both quantitative and qualitative insights.