...
Some of the major air pollutants such as nitrogen oxides, (\ce{NO_x}), and particulate matter (PM) are emitted by road traffic (65\% of \ce{NO_x}, $\approx 35\%$ of PM), mainly by diesel vehicles, and directly inhaled by nearby major city inhabitants.
...
\epigraph{Today, about 50\% of the world population relies on nitrogen-based fertilizers to produce the food necessary to their alimentation.}%{\textit{Nature Catalysis editorial, \cite*{NatureEditorial2018}.}}
...
For an equal amount of \nitrousoxide and \carbondioxide, the amount of \nitrousoxide will trap 298 times more heat than the amount of \carbondioxide over the next 100 years \parencite{MITCLIMATE}, responsible for 6.2\% of the total U.S.A. greenhouse gases emissions in 2021 (fig. \ref{fig:PieGreenhouseNO2}).
...
Since the 1930s, the presence of a platinum-rhodium ($\approx 10 \% Rh$) knitted gauzes catalyst and favourable reaction conditions (e.g. \qty{900}{\degreeCelsius} - \qty{5}{\bar} - excess \dioxygen) allowed a 98 \nitricoxide \% yield to be achieved \parencite{Handforth1934, Heck1982}.
...
The selective catalytic reaction (SCR) using urea or ammonia as reductant (tab. \ref{tab:NitrogenGases}) has proven to be effective and to reach 95\% efficiency \parencite{MitsubishiSCR}.
