...
Since then it was developed into a characterisation tool for \textit{in situ / operando} studies of materials structure, mostly applied to three fields, heterogeneous catalysis \parencite{Vendelbo2014}, electrochemistry \parencite{Ulvestad2015} and the structure and evolution of defects \parencite{Labat2015}.
...
Moreover, new methods such as convolution neural networks (CNN) are under study and have started to show some encouraging results, but are not yet sufficiently robust, particularly in the case of strained particles \parencite{Cherukara2018, Chan2021, Kim2021a, Wu2021a}.
...
\begin{figure}[!htb]
   ...
   \includegraphics[height=4.5cm]{/home/david/Documents/PhD/Figures/bcdi_data/D6/amp_D6.png}
   \caption{
