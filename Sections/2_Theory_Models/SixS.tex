...
It is also possible to heat the sample up to \qty{900}{\degreeCelsius} (at low pressures) for an extended period of time (sec \ref{sec:SXRD100} - \ref{sec:SXRD111}) to anneal the sample after sputtering \parencite{MUSKET1982143}.
