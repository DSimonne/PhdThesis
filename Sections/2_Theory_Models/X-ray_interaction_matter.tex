...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.66\textwidth]{Figures/Introduction/cross_sections.pdf}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.5]{Figures/Introduction/q.pdf}
    \caption{
...
% between the wavevector of the incident photon $\vec{k}_i$ and the wavevector of the scattered photon $\vec{k}_s$.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Introduction/atomic_form_factor.pdf}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[height=5cm]{/home/david/Documents/PhD/Figures/Drawing/blender/FCC.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.5]{Figures/Introduction/BraggLaw.pdf}
    \caption{
...
A Bragg peak results from the constructive interference between waves scattered on a specific set of crystalline planes, at discrete values of the incident angle $\theta$.
...
To summarise, the diffraction peaks in the scattering pattern represent the Fourier components of the crystal's electron density distribution.
...
\begin{figure}[!htb]
    ...
    \includegraphics[width=\textwidth]{Figures/Introduction/CoherenceLengths.pdf}
    \caption{
