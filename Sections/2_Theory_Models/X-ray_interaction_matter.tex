...
\begin{figure}[!htb]
    ...
    \caption{
        Cross-sections for platinum (Z=78) corresponding to different processes occuring when photons interact with matter.
...
At synchrotrons, working in the vertical plane ($\vec{x}, \vec{z}$) is preferable to maximize the intensity of the scattered field.
This has pratical repercussions in surface x-ray diffraction for which it is preferable to work in a vertical geometry to scan large 2D areas of the reciprocal space.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[height=4cm]{/home/david/Documents/PhDScripts/Drawing/blender/FCC.png}
    \includegraphics[height=4cm]{/home/david/Documents/PhD/Figures/introduction/PtClean.pdf}
    \caption{
    ...
    A schematic representation of the unit cell is shown on the right to be able to visualize the positions of each atom.
