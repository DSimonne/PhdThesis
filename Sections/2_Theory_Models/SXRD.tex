\section{Surface x-ray diffraction} \label{sec:SXRD}
...
An example of surface reconstructions is given in fig. \ref{fig:SurfaceReconstructions}, where the latest atomic layer (green) does not have the same periodicity as the bulk layers (orange).
...
% when due to the minimisation of the surface energy from the presence of an ad-atom \parencite{Gupta1981}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[trim=75 150 75 100, clip, width=0.49\textwidth]{Figures/introduction/EwaldSphereInPlane3D.png}
    \includegraphics[trim=75 150 75 100, clip, width=0.49\textwidth]{Figures/introduction/EwaldSphereOutOfPlane3D.png}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[trim=75 150 75 100, clip, width=0.49\textwidth]{Figures/introduction/EwaldSphereSpecular3D.png}
    \caption{
    Ewald sphere represented together with the reciprocal lattice before (green) and after (blue) rotating the sample to satisfy the Laue condition.
