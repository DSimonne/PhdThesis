...
A possible rotation of the reconstruction arrangement with respect to the bulk layer would result in a prefix in the notation.
Let us take the example for which the orange atoms correspond to the Pt(100) surface, in that case the green reconstruction can be described as Pt(100)4x2-R\ang{0}.
