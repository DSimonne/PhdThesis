...
An example of surface reconstructions is given in fig. \ref{fig:SurfaceReconstructions}, where the latest atomic layer (green) does not have the same periodicity as the bulk layers (brown).
