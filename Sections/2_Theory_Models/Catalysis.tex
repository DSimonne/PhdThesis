...
\begin{figure}[!htb]
    \centering
    \includegraphics[trim=50 50 50 50, clip, width=0.49\textwidth]{/home/david/Documents/PhD/Figures/AmmoniaOxidation/ER.pdf}
    \includegraphics[trim=50 50 50 50, clip, width=0.49\textwidth]{/home/david/Documents/PhD/Figures/AmmoniaOxidation/LH.pdf}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[height=4cm]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_facets_cropped.png}
...
The orientation and structure of each facet on the nanoparticle surface, described by its Miller (hkl) indices, has a key role in the surface strain, and in the adsorption properties of the catalysts \parencite{Zhou2012, Wu2017, Altantzis2019, Wu2021}.
...
A modern theoretical approach to the interaction between surface and adsorbates in heterogeneous catalysis has been proposed by Hammer, Norskov and Mavrikakis \parencite*{Hammer1995, Mavrikakis1998, Hammer2000, Norskov2009} for transition metals, which is at the origin of the strain-reactivity studies in the frame of this thesis.
