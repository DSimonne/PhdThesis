\section{Single Pt nanoparticles structure evolution studied by BCDI}\label{sec:BCDINanoparticles}
...
The increase after removal of the dislocation is less pronounced, which shows that the defect can have an impact on the thermal relaxation of nanoparticles.
...
The flash annealing and removal of the dislocation at \qty{150}{\degreeCelsius} had the effect of increasing the average interplanar spacing $d_{111}$, and decreasing the peak FWHM, which can be linked to a decrease of heterogeneous strain inside the particle \parencite{Warren1990}.
...
The measurement at \qty{550}{\degreeCelsius} shows a very large FWHM, reaching the values when the interfacial dislocation was present at lower temperatures.
...
The reason behind this increase of strain were not determined.

At \qty{600}{\degreeCelsius}, the two values of the average interplanar spacing under inert atmosphere are similar to the value at \qty{550}{\degreeCelsius}, and decrease after the introduction of ammonia.
...
The presence of the dislocation network is not clear from the values of the FWHM, a characterisation of the peak FWHM in other direction will yield additionnal information.
...
A similar influence of the epitaxied substrate on the facet strain has been observed for a 100 nm large Pt-Rh nanoparticle by Kim et al. \cite*{Kim2021}.
