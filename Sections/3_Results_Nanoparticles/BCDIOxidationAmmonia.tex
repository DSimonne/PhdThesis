\subsection{Nanoparticle surface structure evolution during ammonia oxidation}\label{sec:BCDIAmmoniaOxidation}
...
% Strain histogram ? useless see the evolution of specific facets, good id not too many facets, also too many scans
...
Increasing the temperature to \qty{400}{\degreeCelsius} under inert atmosphere was at the origin of the appearance of a default in the particle, visible directly in reciprocal space by the shape of the 3D diffraction patterns (fig. \ref{fig:B7Ortho}), which did not improve the phase retrieval quality.
...
The default is also visible perpendicularly to the particle substrate and through the particle in 3D in appendix \ref{app:AppendixB7}, ultimately resulting in holes in the Bragg electronic density \parencite{Clark2015, Dupraz2015}.
...
The summed intensities were then fitted in each direction by a Lorentzian shape function to be able to extract the FWHM of the peak in the three directions ($\sigma_x$, $\sigma_y$ and $\sigma_z$), and compute the average interplanar spacing from the peak position in $q$-space.
...
\begin{figure}[!htb]
    ...
    \caption{
        Evolution of the full width at half maximum (FWHM, $\sigma$) for particle B in the $\vec{q}_x$, $\vec{q}_y$ and $\vec{q}_z$ directions at \qty{25}{\degreeCelsius}, \qty{300}{\degreeCelsius} and \qty{400}{\degreeCelsius} as a function of the ammonia to oxygen ratio.
...
Finally, to be able to give a first estimation of the amount of strain inside the particle, the strain field energy defined as the sum of the product of stress and strain integrated over the particle \parencite{cahn1959free} was computed following the work performed by Ulvestad et al in \cite*{Ulvestad2015a}.
...
\begin{figure}[!hbt]
    ...
    \caption{
        Evolution of the full width at half maximum (FWHM, $\sigma$) for particle C in the $\vec{q}_x$, $\vec{q}_y$ and $\vec{q}_z$ directions at \qty{25}{\degreeCelsius}, \qty{300}{\degreeCelsius} and \qty{400}{\degreeCelsius} as a function of the ammonia to oxygen ratio.
        The reproduction of measurements at fixed conditions yield multiple data points, lines at \qty{300}{\degreeCelsius} and \qty{400}{\degreeCelsius} link the data points in the order of the measurements.
...
However, the transition can be observed in both the strain field energy (fig. \ref{fig:D6SFE}) and in the FWHM of the three-dimensional Bragg peak (fig. \ref{fig:D6FWHM}).
