\subsection{Particle structure evolution during ammonia oxidation at \qty{300}{\degreeCelsius} and \qty{400}{\degreeCelsius}}\label{sec:BCDIAmmoniaOxidation}
...
The two nanoparticles have a very different shape and facet coverage, resumed in tab. \ref{tab:FacetCoverage}.
...
A 3D view of the reconstructed nanoparticles at \qty{300}{\degreeCelsius} and \qty{400}{\degreeCelsius} during the ammonia oxidation cycle is presented in appendix \ref{app:AppendixBCDIOperando}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/hist_B7.pdf}
    \caption{
...
To be able to quantify the strain inside the particle, the 3D diffraction patterns were orthogonalised in $q$-space (fig. \ref{fig:B7Ortho}).
...
\begin{figure}[!htb]
    \centering
    % \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_3479.pdf}
    % \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_3544.pdf}
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_3804_edited.pdf}
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_3863_edited.pdf}
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_4098_edited.pdf}
    % \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/B7_orthogonalized_4110.pdf}
    \caption{
...
The defects are also visible perpendicularly to the particle substrate and through the particle in 3D in appendix \ref{app:AppendixBCDIOperando}, ultimately resulting in holes in the Bragg electronic density \parencite{Clark2015, Dupraz2015}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/fwhm_B7_two_peaks.pdf}
    \caption{
...
The FWHM under argon after and before the oxidation cycle are similar at \qty{300}{\degreeCelsius} but not at \qty{400}{\degreeCelsius}, a temperature at which the oxidation cycle completely changed the shape and strain state of the particle, visible in app. \ref{app:AppendixBCDIOperando}.
The particle shape is not reversible at \qty{400}{\degreeCelsius} after the oxidation cycle.

\begin{SCfigure}
    \centering
    \includegraphics[width=0.6\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/lattice_parameter_B7.pdf}
    \caption{
...
The evolution of the strain field energy as a function of each scan to be able to compare with the 3D reconstructions of the particle shown in app. \ref{app:AppendixBCDIOperando} is presented in fig. \ref{fig:B7SFE}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/B-7/strain_energy_B7.pdf}
    \caption{
...
The increase of strain inside the particle is also visible in 3D by the progressive importance of holes in the reconstructed volume (app. \ref{app:AppendixBCDIOperando}), and by the evolution of the strain field energy (fig. \ref{fig:B7SFE}).
Interestingly, a transition is observed during the simultaneous presence of both ammonia and oxygen in the reactor, when \ce{O_2}/\ce{NH_3} = 1 (scans 3951, 3958 and 4002).
...
Interestingly, no changes in the particle shape or surface strain values have been observed during the exposition to the reactants (appendix \ref{app:AppendixBCDIOperando}).

\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/D6_orthogonalized_3517_edited.pdf}
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/D6_orthogonalized_3572_edited.pdf}
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/D6_orthogonalized_3823_edited.pdf}
    \caption{
...
The reconstructions under inert atmosphere before introducing ammonia or after removing both reactants from the cell presented in appendix \ref{app:AppendixBCDIOperando} have been performed by limiting the support update to every 200 iteration (for a total of 1100 algorithm iteration during phase retrieval, meaning that the support is only changed 5 times), and still present a highly heterogeneous Bragg electronic density.
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/fwhm_D6.pdf}
    \caption{
...
\begin{SCfigure}
    \centering
    \includegraphics[width=0.6\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/lattice_parameter_D6.pdf}
    \caption{
...
The strain at the interface with the substrate also becomes more homogeneous at this condition, slightly negative (appendix \ref{app:AppendixBCDIOperando}).
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/figures/D-6/strain_energy_D6.pdf}
    \caption{
...
% The influence of the introduction of oxygen on the interfacial strain is unclear since no clear and reproducible evolution of the facet strain is visible on the particle surface (app. \ref{app:AppendixBCDIOperando}).
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2021_06_BCDI_NH3/gas_analysis/figures/product_comparison_no_norm.pdf}
    \caption{
