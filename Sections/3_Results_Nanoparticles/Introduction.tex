...
% sxrd
It is first intended to measure the signal scattered from $\alpha$-\ce{Al_2O_3} (sapphire) supported platinum particles by taking advantage of the possibility to carry out grazing-incidence diffraction measurements at the SixS beamline.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.49\textwidth]{/home/david/Documents/PhD/Figures/Sample/Mask.pdf}
...
The epitaxial relationship between the platinum nanoparticles and the $\alpha$-\ce{Al_2O_3} substrate has been shown to consist of Pt \{111\} planes on top of the $\alpha$-\ce{Al_2O_3} (0001) surface (fig. \ref{fig:Epitaxy} - \cite{Farrow1993}).
...
The heater was calibrated by measuring the sample temperature at different argon pressures, with a type K thermocouple fixed on the sample, as a function of the current intensity (fig. \ref{fig:TempRamps} - a).
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.495\textwidth]{/home/david/Documents/PhD/PhDScripts/SixS_2022_01_SXRD_Pt100/gas_analysis/figures/ThermocoupleCalibration.pdf}
    \includegraphics[width=0.495\textwidth]{/home/david/Documents/PhD/PhDScripts/Test_Reactor_CO2_2021_01/Figures/TempRamp2.pdf}
    \caption{
...
To probe the importance of the \ce{O_2}/\ce{NH_3} ratio between partial pressures on the reaction selectivity, and its link with the catalyst structure, ammonia is first introduced in the reactor, followed by a step by step increase of the oxygen pressure.
