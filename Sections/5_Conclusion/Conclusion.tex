...
Bulk \ce{Pt_3O_4} was identified on Pt(100), of mean thickness equal to \qty{16}{\angstrom} (\textit{i.e.} 3 unit cells thick).
...
% Moreover, when describing the signals with the Pt(111)-p$\begin{pmatrix} 1.08 & -0.21 \\ -0.21 & 1.08 \end{pmatrix}$-R\ang{0} matrix, which results in a real space angle of \ang{137.4}, a second-order signal is shared.
