...
% Results
    \chapter{Results}
    \input{Sections/3_Results/BCDI}
    \section{Near-ambient pressure single crystal surface study during the oxidation of ammonia}
    \input{Sections/3_Results/111}
    \input{Sections/3_Results/100}
    \input{Sections/3_Results/EmpiricalAnalysis}
    
% Conclusion
%     \chapter{Conclusion}
%     \input{Sections/4_Conclusion/Conclusion}
...
% Appendices
    ...
    \input{Sections/5_Appendix/OperandoBCDI}
