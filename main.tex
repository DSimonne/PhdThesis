...
\usepackage[style=authoryear, isbn=false, date=year,sorting=nyt, maxcitenames=1, % mincitenames=1,
...
% Results BCDI
    ...
    \chapter{Pt nanoparticles during the oxidation of ammonia}
...
% Results SXRD
    \chapter{Pt single crystals during the oxidation of ammonia}
