...
\usepackage[style=authoryear, isbn=false, date=year,sorting=nyt,mincitenames=1, maxcitenames=2,
    eprint=false,giveninits=true, url=false]{biblatex}
...
% Theory
    ...
    % \input{Sections/2_Theory_Models/CrystalStructures}
...
% Appendices
    ...
    \input{Sections/6_Appendix/DiffractionVocab}

    \chapter{Nanoparticles study}
    \input{Sections/6_Appendix/Nanoparticles}
    \includepdf[pages=-]{/home/david/Documents/PhD/Presentations/Slides/PhdSlides/Figures/bcdi_data/3D_B7.pdf}\label{app:AppendixB7}
    \includepdf[pages=-]{/home/david/Documents/PhD/Presentations/Slides/PhdSlides/Figures/bcdi_data/3D_D6_edited.pdf}\label{app:AppendixD6}
