...
% Results BCDI
    ...
    \input{Sections/3_Results_Nanoparticles/SXRDEpitaxy}
...
% Results SXRD
    ...
    \input{Sections/4_Results_SingleCrystals/Common}
...
% Appendices
    ...
    \chapter{BCDI temperature ramp data}
    \input{Sections/6_Appendix/TempRampBCDI}

    \chapter{3D BCDI \textit{operando} measurements}
    \input{Sections/6_Appendix/OperandoBCDI}
